...
type VersionHistoryServiceClient interface {
	...
	CreateFunctionLog(ctx context.Context, in *FunctionLogReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *versionHistoryServiceClient) CreateFunctionLog(ctx context.Context, in *FunctionLogReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/new_object_builder_service.VersionHistoryService/CreateFunctionLog", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *versionHistoryServiceClient) GetFunctionLogs(ctx context.Context, in *GetFunctionLogsReq, opts ...grpc.CallOption) (*GetFunctionLogsResp, error) {
	...
	err := c.cc.Invoke(ctx, "/new_object_builder_service.VersionHistoryService/GetFunctionLogs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *versionHistoryServiceClient) GetPerformanceMetrics(ctx context.Context, in *GetPerformanceMetricsRequest, opts ...grpc.CallOption) (*GetPerformanceMetricsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/new_object_builder_service.VersionHistoryService/GetPerformanceMetrics", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VersionHistoryServiceServer interface {
	...
	CreateFunctionLog(context.Context, *FunctionLogReq) (*emptypb.Empty, error)
...
func (UnimplementedVersionHistoryServiceServer) CreateFunctionLog(context.Context, *FunctionLogReq) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateFunctionLog not implemented")
}
...
func _VersionHistoryService_CreateFunctionLog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/new_object_builder_service.VersionHistoryService/CreateFunctionLog",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _VersionHistoryService_GetFunctionLogs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/new_object_builder_service.VersionHistoryService/GetFunctionLogs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _VersionHistoryService_GetPerformanceMetrics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/new_object_builder_service.VersionHistoryService/GetPerformanceMetrics",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
