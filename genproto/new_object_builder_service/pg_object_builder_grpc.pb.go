...
type ObjectBuilderServiceClient interface {
	...
	UserActivity(ctx context.Context, in *UserActivityReqeust, opts ...grpc.CallOption) (*emptypb.Empty, error)
	// for ai chat
...
func (c *objectBuilderServiceClient) UserActivity(ctx context.Context, in *UserActivityReqeust, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/new_object_builder_service.ObjectBuilderService/UserActivity", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *objectBuilderServiceClient) ExecuteSQL(ctx context.Context, in *ExecuteSQLRequest, opts ...grpc.CallOption) (*ExecuteSQLResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/new_object_builder_service.ObjectBuilderService/ExecuteSQL", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *objectBuilderServiceClient) GetResourceUsage(ctx context.Context, in *GetResourceUsageRequest, opts ...grpc.CallOption) (*GetResourceUsageResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/new_object_builder_service.ObjectBuilderService/GetResourceUsage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *objectBuilderServiceClient) GetTableSchema(ctx context.Context, in *CommonMessage, opts ...grpc.CallOption) (*CommonMessage, error) {
	out := new(CommonMessage)
	err := c.cc.Invoke(ctx, "/new_object_builder_service.ObjectBuilderService/GetTableSchema", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ObjectBuilderServiceServer interface {
	...
	UserActivity(context.Context, *UserActivityReqeust) (*emptypb.Empty, error)
	// for ai chat
...
func (UnimplementedObjectBuilderServiceServer) UserActivity(context.Context, *UserActivityReqeust) (*emptypb.Empty, error) {
...
func _ObjectBuilderService_UserActivity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/new_object_builder_service.ObjectBuilderService/UserActivity",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ObjectBuilderService_ExecuteSQL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/new_object_builder_service.ObjectBuilderService/ExecuteSQL",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ObjectBuilderService_GetResourceUsage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/new_object_builder_service.ObjectBuilderService/GetResourceUsage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ObjectBuilderService_GetTableSchema_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/new_object_builder_service.ObjectBuilderService/GetTableSchema",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
